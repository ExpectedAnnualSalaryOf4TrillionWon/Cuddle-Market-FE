      ...
      <div className="flex flex-1">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex w-full min-w-32 gap-1">
            {!isCompleted && (
              <Button size="sm" className="hover:bg-primary-300 flex-1 cursor-pointer border border-gray-300 hover:font-bold hover:text-white">
                수정
              </Button>
            )}
            <Button
              ...
              onClick={() => handleConfirmModal(id, title, price, mainImageUrl)}
            >
              삭제
            </Button>
          </div>
