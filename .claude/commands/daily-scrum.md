...
2. **DAILY SCRUM 데이터베이스에 페이지 생성 (curl 사용 필수)**
   ...
   > `cat ~/Library/Caches/claude-cli-nodejs/-Users-osejin-Desktop-Cuddle-Market-FE/mcp-logs-notion/*.txt | grep "Authorization: Bearer" | head -1`
   ...
   curl -X POST 'https://api.notion.com/v1/pages' \
     ...
     -d '{
       "parent": {
         "database_id": "29826170-466f-8063-81b4-fabbc250652a"
       },
       "properties": {
         "이름": {
